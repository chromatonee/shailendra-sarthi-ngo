...
<html lang="en">
<head>
<title>Shailendra Sarthi Foundation - Admin</title>
...
<div class="carepan">
<?php
$totalsql = $PDO->prepare("SELECT * FROM quick_contact WHERE qstatus=1");
$totalsql->execute(); 
...
<div class="carepan">
<?php
$totalsql = $PDO->prepare("SELECT * FROM quick_quote WHERE quote_status=1");
$totalsql->execute(); 
$count = $totalsql->rowCount();
?>
<p><?php echo $count; ?></p>
